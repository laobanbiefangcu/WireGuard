...
show_specific_link() {
    ...
    read -p "请输入客户端编号 (1-10): " client_num
...
if [ -z "${WG_IPV4_NETWORK:-}" ]; then
    ...
    echo "4. 自定义网段"
    read -p "请选择 [1-4]，默认为1: " ipv4_choice
    ...
    case $ipv4_choice in
        ...
        3)
            ...
            ;;
        4)
            read -p "请输入自定义网段前缀 (如 192.168.100): " custom_network
